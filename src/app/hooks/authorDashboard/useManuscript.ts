...
const useManuscript = () => {
  ...
  const getServiceNameById = async (id: string) => {
    ...
    try {
      const response = await fetch(
        `https://secure.tst.manuscriptedit.com/api/get_service_name.php?serv_type_id=${id}`
      );
      if (!response.ok) {
  ...
  const fetchCountryList = async () => {
    try {
      const countryData = await fetch(
        `https://secure.tst.manuscriptedit.com/api/get_all_country_list.php`
      );
      if (!countryData.ok) {
  ...
  const uploadFile = async (
    ...
    try {
      ...
      const response = await fetch(
        "https://secure.tst.manuscriptedit.com/api/editor_order_file_upload.php",
        {
          method: "POST",
          body: formData,
        }
  ...
  const submitQuotation = async (
    ...
    try {
      ...
      const response = await fetch(
        "https://secure.tst.manuscriptedit.com/api/submit_manuscript.php",
        {
          method: "POST",
          headers: {
