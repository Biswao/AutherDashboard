...
export default function Sidebar({ children }: SidebarProps) {
  ...
  const email =
    typeof window !== "undefined" ? localStorage.getItem("email") : undefined;
  ...
  const initials = `${(authorDetails?.first_name ?? "").charAt(0)}${(
  ...
  return (
    <div>
      ...
      <div className="SideabrAllign" style={{ display: "flex" }}>
        {/* Sidebar */}
        <aside
          className={`text-white MobileNoScroll transform transition-transform duration-300 ease-in-out ${
            ...
            <nav className="w-full">
              <ul className="w-full ulListStyle">
                ...
                >
                  <span
                    className={`flex items-center py-2 px-4 ${
                      active === "/UserDashboard/" && "bg-teal-700"
                    } text-left `}
                  >
                ...
                <li
                  className="mb-2 w-full"
                  onClick={() => {
                    router.push("/QuotationNew");
                  }}
                >
                  <span
                    className={`flex items-center py-2 px-4 text-left ${
                      active === "/QuotationNew/" && "bg-teal-700"
                    } hover:bg-gray-700 w-full`}
                  >
                    <FontAwesomeIcon icon={faQuoteRight} className="mr-2" />
                    <span className="flex-grow">Request a Quotation</span>
                  </span>
                </li>
                <li
                  className="mb-2 w-full"
                ...
                >
                  <span
                    className={`flex items-center py-2 px-4 text-left ${
                      active === "/OrderList/" && "bg-teal-700"
                    } hover:bg-gray-700 w-full`}
                  >
                    <FontAwesomeIcon icon={faShoppingCart} className="mr-2" />
                    <span className="flex-grow">View Orders Submitted</span>
                  </span>
                </li>
                <li
                  className="mb-2 w-full"
                ...
                >
                  <span
                    className={`flex items-center py-2 px-4 text-left ${
                      active === "/Referrals/" && "bg-teal-700"
                    } hover:bg-gray-700 w-full`}
                  >
                    <FontAwesomeIcon icon={faUserFriends} className="mr-2" />
                    <span className="flex-grow">Refer A Colleague</span>
                  </span>
                </li>
                <li
                  className="mb-2 w-full"
                ...
                >
                  <span
                    className={`flex items-center py-2 px-4 text-left ${
                      active === "/Coupons/" && "bg-teal-700"
                    } hover:bg-gray-700 w-full`}
                  >
                    <FontAwesomeIcon icon={faGift} className="mr-2" />
                    <span className="flex-grow">Coupon Center</span>
                  </span>
                </li>
                <li
                  className="mb-2 w-full"
                ...
                >
                  <span
                    className={`flex items-center py-2 px-4 text-left ${
                      active === "/Webinars/" && "bg-teal-700"
                    } hover:bg-gray-700 w-full`}
                  >
                    <FontAwesomeIcon icon={faCalendarAlt} className="mr-2" />
                    <span className="flex-grow">Book a slot in Webinar</span>
                  </span>
                </li>
                <li
                  className="mb-2 w-full"
                  onClick={() => {
                    router.push("/TalkExpert");
                  }}
                >
                  <span
                    className={`flex items-center py-2 px-4 text-left ${
                      active === "/TalkExpert/" && "bg-teal-700"
                    } hover:bg-gray-700 w-full`}
                  >
                    <FontAwesomeIcon icon={faComments} className="mr-2" />
                    <span className="flex-grow">Talk to an expert</span>
                  </span>
                </li>
              </ul>
            </nav>
        ...
        {/* Main content area */}
        <main
          className="flex-grow p-4 overflow-y-auto children-component SidebarMain"
          style={{
