...
const UpdateProfile = () => {
  ...
  const user_id =
    typeof window !== "undefined" ? localStorage.getItem("user_id") : undefined;
  const { loading, error, authorDetails, updateAuthorDetails } = useFetchAuthor(
    email ?? undefined
  );
  ...
  useEffect(() => {
    if (authorDetails) {
      setFormData({
        ...
        country:
          countryCode?.find((country) => country.country === authorDetails?.country)?.id || "",
  ...
  return (
    <>
      {loading && countryCode && countryCode.length ? (
        <h1>Loading...</h1>
      ) : (
        <div className="profile-container">
          ...
          <div className="profile-content">
            <div className="profile-sidebar">
              ...
              <button className="change-password-btn" onClick={ClickToogle}>
                {password ? "Change Password" : "Personal Information"}
              </button>
            </div>
            {password && (
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                    >
                      <option value="professor emeritus">
                        Professor Emeritus
                      </option>
                      ...
                      <option value="clinician/medical scientist">
                        Clinician/Medical Scientist
                      </option>
                      <option value="research scientist/associates">
                        Research Scientist/Associates
                      </option>
                      <option value="post doctoral researcher">
                        Post Doctoral Researcher
                      </option>
                      <option value="laboratory manager">
                        Laboratory Manager
                      </option>
                      <option value="instructor/lecturer">
                        Instructor/Lecturer
                      </option>
                      ...
                      <option value="independent author">
                        Independent Author
                      </option>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      value={
                        countryCode?.find(
                          (country) =>
                            country.country === authorDetails?.country
                        )?.id || ""
                      }
                    >
    ...
    <input name="website" type="text" value="" />
                  ...
                  <button
                    className="bg-primary updateButton"
